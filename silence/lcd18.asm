...
LCD_DELAY macro
	...
	code
	global InitLCD,WrtLCD,ClkLCD,ClrLCD,CmdLCD		;Only these functions are visible to other asm files.
    ;***********************************
InitLCD
...
CmdLCD
    ;****************************************
    nop
    bcf	PORTD, RS		;sets command modeandlw b'10000000'		;add 1000 0000;
